...
const styles = StyleSheet.create({
  ...
  attachBtn: {
    ...
    backgroundColor: '#4361EE', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  ...
  sendIcon: { fontSize: 18, color: '#4361EE' },
  ...
  sendRecBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#4361EE', alignItems: 'center', justifyContent: 'center' },
